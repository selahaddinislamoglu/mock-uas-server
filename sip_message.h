...
#define SIP_CALL_ID_MAX_LENGTH 256
#define SIP_TAG_MAX_LENGTH 64
#define SIP_BUILD_TAG_LENGTH 16
#define SIP_BRANCH_MAX_LENGTH 64
#define SIP_URI_MAX_LENGTH 256
...
typedef enum
{
    RESPONSE_CODE_PROVISIONAL_START = 100,
    RESPONSE_CODE_100 = 100,
    RESPONSE_CODE_180 = 180,
    RESPONSE_CODE_PROVISIONAL_END = 199,
    RESPONSE_CODE_SUCCESS_START = 200,
    RESPONSE_CODE_200 = 200,
    RESPONSE_CODE_SUCCESS_END = 299,
    RESPONSE_CODE_REDIRECTION_START = 300,
    RESPONSE_CODE_REDIRECTION_END = 399,
    RESPONSE_CODE_CLIENT_ERROR_START = 400,
    RESPONSE_CODE_400 = 400,
    RESPONSE_CODE_401 = 401,
    RESPONSE_CODE_403 = 403,
    RESPONSE_CODE_404 = 404,
    RESPONSE_CODE_CLIENT_ERROR_END = 499,
    RESPONSE_CODE_SERVER_ERROR_START = 500,
    RESPONSE_CODE_500 = 500,
    RESPONSE_CODE_501 = 501,
    RESPONSE_CODE_SERVER_ERROR_END = 599,
    RESPONSE_CODE_GLOBAL_FAILURE_START = 600,
